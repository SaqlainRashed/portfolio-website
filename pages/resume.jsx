        ...
        <div className='bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center'>
          ...
          <div className='flex'>
            ...
            <a href='https://github.com/SaqlainRashed'
              target='_blank'
              rel='noreferrer'
              class='inline-flex font-bold items-center'>
            {/* <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-1.5 px-3.5 rounded inline-flex items-center"> */}
